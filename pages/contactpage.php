<?php
	include('../includes/data.home.php');
?>
<!DOCTYPE html>
...
Nobleheart love clinic is an online rehabilitation, healing and illumination centre born of love. At our Love Clinic, we help young people enjoy a healthy relationship; also, provide counsel for healthy marriages, parenting and teenage mentoring. We offer services such as Rehabilitations, Counselling Direct coaching">
    ...
    <title>NobleHeart-contact</title>
    <!-- InstanceEndEditable -->
...
<section class="page-content">
  ...
  <div class="row"><!-- InstanceBeginEditable name="content" -->
    ...
    <div class="contactformback">
       <h3 style="color:#fff; text-align:center; padding-top:10px; border-bottom:1px solid #ccc; padding-bottom:10px;">Send Us a Message</h3>
        
        <form class="contactform" action="contactpage.php" method="POST">
          <br />
        Name <br />
        <input type="text" style="color:#000;" name="firstname" size="38" required>
        <p/>
        <br />
        Email <br />
        <input type="email" style="color:#000;" name="email" size="38" required>
        <p/>
        <br />
		<input type="radio" name="gender" value="male" checked> Male<br>
  		<input type="radio" name="gender" value="female"> Female<br>
            <br /><br />
        <textarea class="textholder" style="color:#000;" rows="5" cols="36" name="message" placeholder="Write Message" required></textarea>
            <br /><br />
        <input type="submit" name="submitcontact" style="color:#000;" value="Submit" />
        <br /><br />
        </form>
    </form>
    </div>
