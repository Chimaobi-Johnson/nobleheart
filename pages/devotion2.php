...
<section class="page-content">
  ...
  <div class="row"><!-- InstanceBeginEditable name="content" -->
     <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 page-blog">
      <h2 style="text-align:center;">Love Devotionals</h2>
        <p style="line-height: 2.0; padding: 30px 10px; text-align: justify">

Devotionals Coming Soon...........

</p>
       <ul class="pagination">
          <li><a href="devotionals.php">1</a></li>
          <li class="active"><a href="devotion2.php">2</a></li>
          <li><a href="devotion3.php">3</a></li>
        </ul>
    </div>
  <!-- InstanceEndEditable -->
