...
Nobleheart love clinic is an online rehabilitation, healing and illumination centre born of love. At our Love Clinic, we help young people enjoy a healthy relationship; also, provide counsel for healthy marriages, parenting and teenage mentoring. We offer services such as Rehabilitations, Counselling Direct coaching">
    ...
    <title>NobleHeart-devotionals</title>
    <!-- InstanceEndEditable -->
...
<div id="topnavbar">
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <ul class="nav navbar-nav">
                ...
                <li class="active"><a data-toggle="modal" data-target="#myModal2" href="#">LOVE DEVOTIONALS</a></li>
...
<section class="page-content">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Welcome to Noble-Heart love devotionals, here you have access to all devotionals at a click of a button</p>
        </div>
  ...
  <h2>LOVE DEVOTIONALS</h2>
  <p style="line-height: 2.5; padding: 10px; text-align: justify">
Daily Love Devotionals Archives
  <ul class="dev">
    <li><a href="../files/january_2018_devotional.pdf" style="text-decoration: none;">January 2018 Devotionals</a></li>
    <li><a href="../files/febuary_2018_devotional.pdf" style="text-decoration: none;">Febuary 2018 Devotionals</a></li>
    <li><a href="../files/march_2018_devotional.pdf" style="text-decoration: none;">March 2018 Devotionals</a></li>
  </ul>
  </p>
