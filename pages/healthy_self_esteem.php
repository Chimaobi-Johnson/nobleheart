...
Nobleheart love clinic is an online rehabilitation, healing and illumination centre born of love. At our Love Clinic, we help young people enjoy a healthy relationship; also, provide counsel for healthy marriages, parenting and teenage mentoring. We offer services such as Rehabilitations, Counselling Direct coaching">
    ...
    <title>NobleHeart-Healthy_self_esteem</title>
    <!-- InstanceEndEditable -->
...
<div id="topnavbar">
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="healthy_self_esteem.php">HEALTHY SELF-ESTEEM</a></li>
...
<section class="page-content">
  ...
  <div class="row"><!-- InstanceBeginEditable name="content" -->
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 page-about-jeff">
      <h4 style="text-align: center; border-bottom: 1px solid #ccc; padding-bottom: 30px; padding-top: 30px;">HEALTHY SELF-ESTEEM</h4>
      <div class="self">
      <img src="../img/book.jpg" width="100%" alt="healthy_self_esteem book">
    </div>
      <p style="line-height: 2.0; padding: 30px; text-align: justify; float: left;">Healthy esteem is a book authored by Jeffery Martins. Softcopy is available, click <a href="http://www.selar.co/m/Jeffery-Martins" target="blank" style="text-decoration:none; color:#099;">this link</a> to purchase at our <a href="http://www.selar.co/m/Jeffery-Martins" target="blank" style="text-decoration:none; color:#099;">selar.com</a> page.<br /> You can also read about the book <a href="about_health_esteem.html" style="text-decoration:none; color: #04a0c5">here</a></p>
      <h4 style="line-height: 2.0; padding: 10px 30px; text-align: center; float: left; ">HALL OF FAME OF OUR SELF ESTEEM GLOBAL CAMPAIGN </h4>
      <div class="imgboxes">
        <div class="imgbox 1"><img src="../img/articles/tj.jpg" width="100%" height="330px">
          <h5>TEAJAY CHUNU -Social Entrepreneur, team coach, brand strategist and PurplePatch consultant. Signed up for our Healthy Self Esteem global campaign at Novotel hotels, Port Harcourt. </h5>
        </div>
        <div class="imgbox 2"><img src="../img/articles/pst_eseyin.jpg" width="100%" height="330px">
          <h5>TEMIDAYO ESEYIN - CEO at Temidayo and Co Law Firm and Associate Pastor LFC Ilorin state church. Signed for our Healthy Self Esteem global campaign at his residence Ilorin. </h5>
        </div>
        <div class="imgbox 3"><img src="../img/articles/selfest4.jpg" width="100%" height="330px">
          <h5>PASTOR ISRAEL AKINSANYA - State Pastor of Living Faith Church, Ilorin, Kwara State. Signed up our Healthy Self Esteem global campaign at his office. </h5>
        </div>
        <div class="imgbox 4"><img src="../img/articles/selfest.jpg" width="100%" height="330px">
          <h5>MRS. MOJI EYEYE - T.O.M Coordinator Kwara State and Senior Lecturer University of Ilorin. Signed up for our Healthy Self Esteem global campaign at her office in Ilorin. </h5>
        </div>
        <div class="imgbox 5"><img src="../img/articles/selfest2.jpg" width="100%" height="330px">
          <h5>BURUTOLU AUGUSTINE - Leadership Solutions Provider, Author and CEO Zygote Consulting LTD. Signed up for our Healthy Self Esteem global campaign at Novotel Hotels, Port Harcourt. </h5>
        </div>
        <div class="imgbox 6"><img src="../img/articles/selfest3.jpg" width="100%" height="330px">
          <h5>AYODEJI OLUWADELE - Associate Pastor Living Faith Church, Ekpoma and CEO Heritage Supermarkets. Signed up for our Healthy Self Esteem global campaign at Ekpoma. </h5>
        </div>
        <div class="imgbox 7">
          <img src="../img/articles/selfest5.jpg" width="100%" height="360px">
          <h5>Senior Pastors of LFC Ekpoma Signing up for Project Healthy Self Esteem. </h5>
        </div>
      </div>
      <table style="border-top: 1px solid #ccc; margin-top: 50px; margin-bottom: 10px">
        <tr>
          <td style="padding-left: 50px"><img src="../img/png/facebook.png" style="margin-top: 10px" width="50px" height="50px"></td>
          <td style="padding-left: 10px; padding-top: 10px">Like Us in Facebook</td>
          <td style="padding-left: 50px"><img src="../img/png/twitter.png" style="margin-top: 10px" width="50px" height="50px"></td>
          <td style="padding-left: 10px; padding-top: 10px">Follow Us on Twitter</td>
          <td style="padding-left: 50px"><img src="../img/png/whatsapp.png" style="margin-top: 10px" width="50px" height="50px"></td>
          <td style="padding-left: 10px; padding-top: 10px">Join Our Whatsapp group</td>
        </tr>
    </table>
    </div>
  <!-- InstanceEndEditable -->
